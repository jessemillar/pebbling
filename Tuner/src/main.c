...
{
	rot_bitmap_layer_set_angle(j_bitmap_layer_hours, tick_time->tm_hour * TRIG_MAX_ANGLE / 60);
	rot_bitmap_layer_set_angle(j_bitmap_layer_mask, tick_time->tm_hour * TRIG_MAX_ANGLE / 60);
}
